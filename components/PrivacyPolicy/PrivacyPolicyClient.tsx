        ...
        <div className="max-w-[1280px] mx-auto px-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-12 items-start">
            ...
            <aside className="hidden lg:block">
              ...
              >
                <div className="font-mono text-[10px] uppercase tracking-[0.12em] text-[#4f6eff] mb-5">
                ...
                <nav className="flex flex-col gap-1">
                  {policy.sections.map((s) => (
                    ...
                    >
                      <span className="font-mono text-[10px] text-[#4f6eff] flex-shrink-0 group-hover:text-[#4f6eff]">
                        {s.number}
                      </span>
                      {s.title}
                    </a>
              ...
              {policy.sections.map((s) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3 mb-6">
                    <span className="font-mono text-[10px] uppercase tracking-[0.14em] text-[#4f6eff]">
                      {s.number}
                    </span>
